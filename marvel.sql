...
-- SELECT * FROM movies;
--
-- 6Create a new entry in the 'people' table with the name of one of the instructors.
--
...
-- VALUES('Guardians of the Galaxy 2', 2017, '22:15');
--
...
--  DELETE FROM attendances WHERE person_id IN (1, 2, 3);
